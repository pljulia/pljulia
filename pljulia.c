...
_PG_init(void)
{
	...
	{
		/*
		 * Julia package name could theoretically be the filename max minus the
		 * extension.  But keep it simple and just account for the Julia
		 * "using" keyword when loading packages.
		 */
		char		packname[NAME_MAX + 7];
		jl_value_t *package;
